      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-white/10 pb-6">
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/ngo/map"
              className="px-4 py-2.5 rounded-xl bg-sky-600 hover:bg-sky-500 text-white font-bold text-xs uppercase tracking-wider shadow-tech-glow flex items-center gap-2 transition-transform active:scale-95"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="glass-panel rounded-2xl p-5 border border-emergency-500/30 bg-emergency-500/[0.04]">
            ...
            <p className="text-[11px] text-slate-400 mt-1">Requiring immediate response</p>
          </div>
          ...
          <div className="glass-panel rounded-2xl p-5 border border-sky-500/30 bg-sky-500/[0.04]">
            ...
            <p className="text-[11px] text-slate-400 mt-1">Active field operations</p>
          </div>
          ...
          <div className="glass-panel rounded-2xl p-5 border border-emerald-500/30 bg-emerald-500/[0.04]">
            ...
            <p className="text-[11px] text-slate-400 mt-1">Successful resolutions</p>
          </div>
          ...
          <div className="glass-panel rounded-2xl p-5 border border-amber-500/30 bg-amber-500/[0.04]">
            ...
            <p className="text-[11px] text-slate-400 mt-1">Blood, water, medical, beds</p>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 glass-panel rounded-3xl p-6 border border-white/10 space-y-4">
            ...
            <div className="space-y-3">
              {activeEmergencies.slice(0, 4).map((req) => (
                <div
                  key={req.id}
                  className="p-4 rounded-xl bg-white/5 hover:bg-white/10 border border-white/5 hover:border-emergency-500/40 transition-all flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4"
                >
                  ...
                  <div className="flex items-center gap-2 shrink-0 w-full sm:w-auto justify-end">
                    ...
                    <button
                      ...
                      className="px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs uppercase tracking-wider shadow-sm"
                    >
                      Accept & Handle
                    </button>
                  </div>
          ...
          <div className="glass-panel rounded-3xl p-6 border border-white/10 space-y-4">
            ...
            <div className="space-y-3">
              {resources.slice(0, 4).map((res) => {
                ...
                return (
                  <div key={res.id} className="p-3 rounded-xl bg-white/5 border border-white/5">
                    <div className="flex items-center justify-between text-xs mb-1.5">
                      <span className="font-bold text-white">{res.type}</span>
