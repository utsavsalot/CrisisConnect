    ...
    <div className="min-h-screen bg-[#070B14] py-8 px-4 sm:px-6 lg:px-8 text-slate-100">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        {notifications.length === 0 ? (
          <div className="glass-panel rounded-3xl p-12 text-center border border-white/10 max-w-sm mx-auto mt-8">
            <Bell className="w-8 h-8 text-slate-500 mx-auto mb-3" />
            <h3 className="font-bold text-sm text-white">You're up to date.</h3>
              ...
              >
                ...
                {n.requestId && (
                  <Link
                    ...
                    className="text-[11px] px-3 py-1.5 rounded-lg bg-white/10 hover:bg-white/20 text-white font-semibold shrink-0"
                  >
                    View
                  </Link>
                )}
