    ...
    <div className="min-h-screen bg-[#f4f5f8] px-4 py-8 text-black sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl space-y-12">
        ...
        <section className="grid min-h-[calc(100vh-12rem)] items-center gap-10 lg:grid-cols-[1.05fr_.95fr]">
          ...
          <div className="relative overflow-hidden rounded-[2rem] border-2 border-black bg-[#e74636] p-7 shadow-[0_22px_55px_rgba(231,70,54,.22)] sm:p-10">
          ...
          <div className="relative overflow-hidden rounded-[2rem] border-2 border-black bg-white p-6 sm:p-10">
            ...
            <p className="mt-6 max-w-md font-instrument text-2xl leading-tight text-black sm:text-4xl">“Your coordinates, your need, and a direct line to people who can act.”</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            {/* Offer Help / Community Helper Card */}
            <div className="space-y-4 rounded-[2rem] border border-black/10 bg-white/95 p-6 shadow-[0_20px_55px_rgba(15,23,42,0.14)]">
              ...
              <div>
                <p className="text-xs text-black/70 leading-relaxed">
                  {isResponder && isAvailable
                    ? 'You are active as a community helper for nearby emergencies.'
              ...
              {isResponder && isAvailable && (
                <div className="space-y-2 pt-2 border-t border-black/10">
                  <span className="block font-mono text-[10px] font-bold uppercase tracking-wider text-black/60">
                    Your Help Capabilities
                  </span>
                  <div className="flex flex-wrap gap-1.5">
                    {(['Medical Assistance', 'Blood', 'Medicine', 'Food', 'Shelter', 'Transportation', 'Rescue', 'Water', 'Other'] as const).map((cat) => {
                        ...
                        <button
                          ...
                          className={`rounded-full px-2.5 py-1 text-[11px] font-semibold transition-all ${
                            isSelected
                              ...
                              : 'border border-black/15 bg-[#f4f5f8] text-black hover:border-black/30'
                          }`}
                        >
                          {cat}
                        </button>
